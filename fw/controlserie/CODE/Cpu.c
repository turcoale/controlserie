...
void _EntryPoint(void)
{
  ...
  setReg8(SOPT1, 0x02);                 
  /* SOPT2: COPCLKS=0,COPW=0,??=0,ACIC=0,??=0,??=0,T1CH1PS=1,T1CH0PS=0 */
  setReg8(SOPT2, 0x02);                 
...
void PE_low_level_init(void)
{
  ...
  clrReg8Bits(PTAPE, 0x03);             
  /* PTADD: PTADD1=0,PTADD0=0 */
  clrReg8Bits(PTADD, 0x03);             
  /* PTCPE: PTCPE1=0 */
  clrReg8Bits(PTCPE, 0x02);             
  /* PTCDD: PTCDD1=0 */
  clrReg8Bits(PTCDD, 0x02);             
  /* PTBPE: PTBPE4=0 */
  clrReg8Bits(PTBPE, 0x10);             
  /* PTBDD: PTBDD4=0 */
  clrReg8Bits(PTBDD, 0x10);             
  ...
  TIMER_Init();
  /* ### Timer capture encapsulation "TM" init code ... */
  TM_Init();
  /* ### Timer capture encapsulation "PT" init code ... */
  PT_Init();
  /* ### Timer capture encapsulation "LP" init code ... */
  LP_Init();
  /* ### Timer capture encapsulation "HP" init code ... */
  HP_Init();
