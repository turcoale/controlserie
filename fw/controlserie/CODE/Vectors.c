...
void (* near const _vect[])(void) @0xFFC0 = { /* Interrupt vector table */
         ...
         HP_Interrupt,                 /* Int.no. 13 Vtpm2ch1 (at FFE4)              Used */
         LP_Interrupt,                 /* Int.no. 12 Vtpm2ch0 (at FFE6)              Used */
         ...
         PT_Interrupt,                 /* Int.no.  6 Vtpm1ch1 (at FFF2)              Used */
         TM_Interrupt,                 /* Int.no.  5 Vtpm1ch0 (at FFF4)              Used */
